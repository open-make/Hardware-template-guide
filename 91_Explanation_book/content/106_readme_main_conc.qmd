...
Always indicate software name and version, possibly adding a link to the software online home.
...
> Example:
>
> This readme file, the 01_community, 02_project_history, and 05_user_guides folders are shared under a CC-BY-4.0 license, the 03_specification_concept and 04_hardware folders are shared under a CERN-OHL-P-2.0 license.
...
@sec-open-next-work, @sec-journal-of-open-hardware, @sec-source-turing, @sec-source-OKH
