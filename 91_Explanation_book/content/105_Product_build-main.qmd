...
When there are multiple parts, it is best practice to split the project into different modules and have a BOM for each part, and one BOM for the whole hardware.
