...
> An important part of this step is the **research of similar project (last element of the checklist).** You may end up joining an existing community and extending (adding a new module) or adapting an (or combining several) existing open hardware solutions.
