...
If possible, create and provide your CAD files in an open format, using oan pen source software.
Also try to name files with a clear name, add material specification and number of pieces.
